  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-slate-800">
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto ">
        <div className="bg-white shadow-xl rounded-2xl px-8 py-10 dark:bg-slate-900">
          <h1 className="text-3xl font-bold text-center text-indigo-600 dark:text-blue-600 mb-8">
            Add a New School
          </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid  grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label htmlFor="imageFile" className="block font-bold text-gray-700 mb-1 dark:text-gray-300">
                Upload School Image
              </label>
              <input
                type="file"
...
function FormInput({ label, id, type = "text", register, error }) {
  return (
    <div>
      <label htmlFor={id} className="block font-bold text-gray-700 mb-1 dark:text-gray-300">
        {label}
      </label>
      <input
        type={type}
